<template>
  <div>
    ...
    <el-form v-if="loaded" :model="form" label-width="160px" class="policy-form">
...
const form = reactive({
  ...
  circuitMinCalls: 20,
  circuitWaitSec: 30,
  circuitFallback: '{"code":503,"message":"服务熔断中，请稍后重试","data":null}',
  retryEnabled: true,
  retryMaxAttempts: 2,
  retryIntervalMs: 500
})
